...
@SourceType(value = "PAARP", label = "PA",uiConfig = "pa-layout.json")
public class PAConf extends AbstractArpConf<PAConf> {
  private static final String ARP_FILENAME = "arp/implementation/pa-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.pa.PADriver";
